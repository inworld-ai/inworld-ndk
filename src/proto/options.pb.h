...
class ExampleValue final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ExampleValue(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ExampleValue* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::Value* ExampleValue::mutable_example(int index) {
  ...
  return _impl_.example_.Mutable(index);
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Value& ExampleValue::_internal_example(int index) const {
  return _impl_.example_.Get(index);
}
...
inline ::PROTOBUF_NAMESPACE_ID::Value* ExampleValue::_internal_add_example() {
  return _impl_.example_.Add();
}
inline ::PROTOBUF_NAMESPACE_ID::Value* ExampleValue::add_example() {
  ::PROTOBUF_NAMESPACE_ID::Value* _add = _internal_add_example();
