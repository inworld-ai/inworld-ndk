...
std::unique_ptr< ApiKeys::Stub> ApiKeys::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< ApiKeys::Stub> stub(new ApiKeys::Stub(channel, options));
  return stub;
}

ApiKeys::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ListApiKeys_(ApiKeys_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SuspendApiKey_(ApiKeys_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ActivateApiKey_(ApiKeys_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteApiKey_(ApiKeys_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GenerateApiKey_(ApiKeys_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void ApiKeys::Stub::async::ListApiKeys(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::ListApiKeysRequest* request, ::ai::inworld::studio::v1alpha::ListApiKeysResponse* response, std::function<void(::grpc::Status)> f) {
...
void ApiKeys::Stub::async::ListApiKeys(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::ListApiKeysRequest* request, ::ai::inworld::studio::v1alpha::ListApiKeysResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ApiKeys::Stub::async::SuspendApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::SuspendApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, std::function<void(::grpc::Status)> f) {
...
void ApiKeys::Stub::async::SuspendApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::SuspendApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ApiKeys::Stub::async::ActivateApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::ActivateApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, std::function<void(::grpc::Status)> f) {
...
void ApiKeys::Stub::async::ActivateApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::ActivateApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ApiKeys::Stub::async::DeleteApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::DeleteApiKeyRequest* request, ::google::protobuf_inworld::Empty* response, std::function<void(::grpc::Status)> f) {
...
void ApiKeys::Stub::async::DeleteApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::DeleteApiKeyRequest* request, ::google::protobuf_inworld::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
void ApiKeys::Stub::async::GenerateApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::GenerateApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, std::function<void(::grpc::Status)> f) {
...
void ApiKeys::Stub::async::GenerateApiKey(::grpc::ClientContext* context, const ::ai::inworld::studio::v1alpha::GenerateApiKeyRequest* request, ::ai::inworld::studio::v1alpha::ApiKey* response, ::grpc::ClientUnaryReactor* reactor) {
