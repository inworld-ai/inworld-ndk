...
class WorkspaceLimitInfo_BatchLimit PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kTotalCrudFieldNumber = 1,
    kTotalNonCrudFieldNumber = 2,
  };
  // int32 total_crud = 1;
  void clear_total_crud();
  ::PROTOBUF_NAMESPACE_ID::int32 total_crud() const;
  void set_total_crud(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_total_crud() const;
  void _internal_set_total_crud(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // int32 total_non_crud = 2;
  void clear_total_non_crud();
  ::PROTOBUF_NAMESPACE_ID::int32 total_non_crud() const;
  void set_total_non_crud(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_total_non_crud() const;
  void _internal_set_total_non_crud(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::int32 total_crud_;
  ::PROTOBUF_NAMESPACE_ID::int32 total_non_crud_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_ai_2finworld_2fstudio_2fv1alpha_2fworkspaces_2eproto;
};
// -------------------------------------------------------------------
...
// int32 total_crud = 1;
inline void WorkspaceLimitInfo_BatchLimit::clear_total_crud() {
  total_crud_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorkspaceLimitInfo_BatchLimit::_internal_total_crud() const {
  return total_crud_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorkspaceLimitInfo_BatchLimit::total_crud() const {
  // @@protoc_insertion_point(field_get:ai.inworld.studio.v1alpha.WorkspaceLimitInfo.BatchLimit.total_crud)
  return _internal_total_crud();
}
inline void WorkspaceLimitInfo_BatchLimit::_internal_set_total_crud(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  total_crud_ = value;
}
inline void WorkspaceLimitInfo_BatchLimit::set_total_crud(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_total_crud(value);
  // @@protoc_insertion_point(field_set:ai.inworld.studio.v1alpha.WorkspaceLimitInfo.BatchLimit.total_crud)
}

// int32 total_non_crud = 2;
inline void WorkspaceLimitInfo_BatchLimit::clear_total_non_crud() {
  total_non_crud_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorkspaceLimitInfo_BatchLimit::_internal_total_non_crud() const {
  return total_non_crud_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WorkspaceLimitInfo_BatchLimit::total_non_crud() const {
  // @@protoc_insertion_point(field_get:ai.inworld.studio.v1alpha.WorkspaceLimitInfo.BatchLimit.total_non_crud)
  return _internal_total_non_crud();
}
inline void WorkspaceLimitInfo_BatchLimit::_internal_set_total_non_crud(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  total_non_crud_ = value;
}
inline void WorkspaceLimitInfo_BatchLimit::set_total_non_crud(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_total_non_crud(value);
  // @@protoc_insertion_point(field_set:ai.inworld.studio.v1alpha.WorkspaceLimitInfo.BatchLimit.total_non_crud)
}
