...
static void InitDefaultsscc_info_AcceptTosRequest_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::AcceptTosRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_DeleteUserRequest_users_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::ai::inworld::studio::v1alpha::DeleteUserRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DeleteUserRequest_users_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DeleteUserRequest_users_2eproto}, {}};
...
static void InitDefaultsscc_info_GenerateTokenUserRequest_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::GenerateTokenUserRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_GenerateTokenUserResponse_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::GenerateTokenUserResponse::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_GetUserRequest_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::GetUserRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_LinkAccountRequest_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::LinkAccountRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_UpdateUserRequest_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::UpdateUserRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_User_users_2eproto() {
  ...
  ::ai::inworld::studio::v1alpha::User::InitAsDefaultInstance();
}
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_users_2eproto[8];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_users_2eproto[3];
...
const char descriptor_table_protodef_users_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "stamp.proto\032\roptions.proto\"a\n\030GenerateTo"
  "kenUserRequest\0226\n\004type\030\001 \001(\0162#.ai.inworl"
  "d.studio.v1alpha.AuthTypeB\003\340A\002\022\r\n\005token\030"
  "\002 \001(\t\"\206\001\n\031GenerateTokenUserResponse\022\r\n\005t"
  ...
  "}\n\021UpdateUserRequest\0222\n\004user\030\001 \001(\0132\037.ai."
  "inworld.studio.v1alpha.UserB\003\340A\002\0224\n\013upda"
  "te_mask\030\002 \001(\0132\032.google.protobuf.FieldMas"
  "kB\003\340A\002\"\234\003\n\004User\022\021\n\004name\030\001 \001(\tB\003\340A\002\022\026\n\toc"
  "ulus_id\030\003 \001(\tB\003\340A\003\022\030\n\013firebase_id\030\004 \001(\tB"
  "\003\340A\003\022#\n\026tos_acceptance_version\030\005 \001(\005B\003\340A"
  "\003\022F\n\021marketing_consent\030\006 \001(\0162+.ai.inworl"
  "d.studio.v1alpha.MarketingConsent\022W\n\032mar"
  "keting_platform_purpose\030\007 \001(\01623.ai.inwor"
  "ld.studio.v1alpha.MarketingPlatformPurpo"
  ...
  "\323\344\223\002\031*\027/v1alpha/{name=users/*}\332A\004nameB\224\001"
  "\n\031ai.inworld.studio.v1alphaB\nUsersProtoP"
  "\001ZMgithub.com/inworld-ai/inworld/serving"
  "/grpc-gateway/build/proto/studio/v1alpha"
  "\252\002\031Ai.Inworld.Studio.V1Alphab\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_users_2eproto_deps[8] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_users_2eproto_sccs[8] = {
  &scc_info_AcceptTosRequest_users_2eproto.base,
  &scc_info_DeleteUserRequest_users_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_users_2eproto = {
  false, false, descriptor_table_protodef_users_2eproto, "users.proto", 2876,
  &descriptor_table_users_2eproto_once, descriptor_table_users_2eproto_sccs, descriptor_table_users_2eproto_deps, 8, 8,
  schemas, file_default_instances, TableStruct_users_2eproto::offsets,
  file_level_metadata_users_2eproto, 8, file_level_enum_descriptors_users_2eproto, file_level_service_descriptors_users_2eproto,
};
...
void GenerateTokenUserRequest::InitAsDefaultInstance() {
}
...
void GenerateTokenUserResponse::InitAsDefaultInstance() {
  ::ai::inworld::studio::v1alpha::_GenerateTokenUserResponse_default_instance_._instance.get_mutable()->expiration_time_ = const_cast< PROTOBUF_NAMESPACE_ID::Timestamp*>(
...
void GenerateTokenUserResponse::SharedCtor() {
  ...
  ::memset(&expiration_time_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&is_created_) -
...
void LinkAccountRequest::InitAsDefaultInstance() {
}
...
LinkAccountRequest::LinkAccountRequest(const LinkAccountRequest& from)
  ...
  if (!from._internal_oculus_oauth_token().empty()) {
    oculus_oauth_token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_oculus_oauth_token(),
      GetArena());
  }
...
// @@protoc_insertion_point(message_clear_start:ai.inworld.studio.v1alpha.LinkAccountRequest)
  ...
  oculus_oauth_token_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void AcceptTosRequest::InitAsDefaultInstance() {
}
...
void UpdateUserRequest::InitAsDefaultInstance() {
  ::ai::inworld::studio::v1alpha::_UpdateUserRequest_default_instance_._instance.get_mutable()->user_ = const_cast< ::ai::inworld::studio::v1alpha::User*>(
      ::ai::inworld::studio::v1alpha::User::internal_default_instance());
  ::ai::inworld::studio::v1alpha::_UpdateUserRequest_default_instance_._instance.get_mutable()->update_mask_ = const_cast< PROTOBUF_NAMESPACE_ID::FieldMask*>(
...
User::User(const User& from)
  ...
  if (!from._internal_oculus_id().empty()) {
    oculus_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_oculus_id(),
      GetArena());
  }
  ...
  if (!from._internal_firebase_id().empty()) {
    firebase_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_firebase_id(),
      GetArena());
  }
...
// @@protoc_insertion_point(message_clear_start:ai.inworld.studio.v1alpha.User)
  ...
  name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  oculus_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  firebase_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
void DeleteUserRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_DeleteUserRequest_users_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
