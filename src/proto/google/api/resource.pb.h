...
enum ResourceDescriptor_History : int {
  ...
  ResourceDescriptor_History_ResourceDescriptor_History_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ResourceDescriptor_History_ResourceDescriptor_History_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum ResourceDescriptor_Style : int {
  ...
  ResourceDescriptor_Style_ResourceDescriptor_Style_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ResourceDescriptor_Style_ResourceDescriptor_Style_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class ResourceDescriptor final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ResourceDescriptor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ResourceDescriptor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_name_field(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_name_field(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_plural(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_plural(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_singular(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_singular(const std::string& value);
...
class ResourceReference final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_child_type(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_child_type(const std::string& value);
...
void ResourceDescriptor::set_type(ArgT0&& arg0, ArgT... args) {
...
inline std::string* ResourceDescriptor::add_pattern() {
  std::string* _s = _internal_add_pattern();
...
inline std::string* ResourceDescriptor::mutable_pattern(int index) {
  ...
  return _impl_.pattern_.Mutable(index);
}
inline void ResourceDescriptor::set_pattern(int index, const std::string& value) {
  _impl_.pattern_.Mutable(index)->assign(value);
...
inline void ResourceDescriptor::set_pattern(int index, std::string&& value) {
  _impl_.pattern_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:google.api.ResourceDescriptor.pattern)
}
...
inline void ResourceDescriptor::set_pattern(int index, const char* value, size_t size) {
  _impl_.pattern_.Mutable(index)->assign(
...
inline void ResourceDescriptor::add_pattern(std::string&& value) {
  _impl_.pattern_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:google.api.ResourceDescriptor.pattern)
}
...
inline void ResourceDescriptor::add_pattern(const char* value, size_t size) {
  _impl_.pattern_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceDescriptor::set_name_field(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_field_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResourceDescriptor::_internal_set_name_field(const std::string& value) {
  ...
  _impl_.name_field_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceDescriptor::_internal_mutable_name_field() {
  
  return _impl_.name_field_.Mutable(GetArenaForAllocation());
}
...
inline void ResourceDescriptor::set_allocated_name_field(std::string* name_field) {
  ...
  _impl_.name_field_.SetAllocated(name_field, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceDescriptor::set_plural(ArgT0&& arg0, ArgT... args) {
 
 _impl_.plural_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResourceDescriptor::_internal_set_plural(const std::string& value) {
  ...
  _impl_.plural_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceDescriptor::_internal_mutable_plural() {
  
  return _impl_.plural_.Mutable(GetArenaForAllocation());
}
...
inline void ResourceDescriptor::set_allocated_plural(std::string* plural) {
  ...
  _impl_.plural_.SetAllocated(plural, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceDescriptor::set_singular(ArgT0&& arg0, ArgT... args) {
 
 _impl_.singular_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResourceDescriptor::_internal_set_singular(const std::string& value) {
  ...
  _impl_.singular_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceDescriptor::_internal_mutable_singular() {
  
  return _impl_.singular_.Mutable(GetArenaForAllocation());
}
...
inline void ResourceDescriptor::set_allocated_singular(std::string* singular) {
  ...
  _impl_.singular_.SetAllocated(singular, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline ::google::api::ResourceDescriptor_Style ResourceDescriptor::_internal_style(int index) const {
  return static_cast< ::google::api::ResourceDescriptor_Style >(_impl_.style_.Get(index));
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceReference::set_child_type(ArgT0&& arg0, ArgT... args) {
 
 _impl_.child_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResourceReference::_internal_set_child_type(const std::string& value) {
  ...
  _impl_.child_type_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceReference::_internal_mutable_child_type() {
  
  return _impl_.child_type_.Mutable(GetArenaForAllocation());
}
...
inline void ResourceReference::set_allocated_child_type(std::string* child_type) {
  ...
  _impl_.child_type_.SetAllocated(child_type, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
