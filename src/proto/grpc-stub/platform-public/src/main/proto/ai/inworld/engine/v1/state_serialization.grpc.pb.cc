...
::grpc::Status StateSerialization::Stub::GetSessionState(::grpc::ClientContext* context, const ::ai::inworld::engine::v1::GetSessionStateRequest& request, ::ai::inworld::engine::v1::SessionState* response) {
  return ::grpc::internal::BlockingUnaryCall< ::ai::inworld::engine::v1::GetSessionStateRequest, ::ai::inworld::engine::v1::SessionState, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetSessionState_, context, request, response);
}
...
void StateSerialization::Stub::experimental_async::GetSessionState(::grpc::ClientContext* context, const ::ai::inworld::engine::v1::GetSessionStateRequest* request, ::ai::inworld::engine::v1::SessionState* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::ai::inworld::engine::v1::GetSessionStateRequest, ::ai::inworld::engine::v1::SessionState, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetSessionState_, context, request, response, std::move(f));
}
...
::grpc::ClientAsyncResponseReader< ::ai::inworld::engine::v1::SessionState>* StateSerialization::Stub::PrepareAsyncGetSessionStateRaw(::grpc::ClientContext* context, const ::ai::inworld::engine::v1::GetSessionStateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::ai::inworld::engine::v1::SessionState, ::ai::inworld::engine::v1::GetSessionStateRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetSessionState_, context, request);
}
...
StateSerialization::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< StateSerialization::Service, ::ai::inworld::engine::v1::GetSessionStateRequest, ::ai::inworld::engine::v1::SessionState, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](StateSerialization::Service* service,
