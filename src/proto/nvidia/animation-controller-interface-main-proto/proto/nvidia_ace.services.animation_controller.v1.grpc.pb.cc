...
#include "nvidia/animation-controller-interface-main-proto/proto/nvidia_ace.services.animation_controller.v1.grpc.pb.h"
...
::grpc::Status AnimationControllerService::Stub::RequestAnimationIds(::grpc::ClientContext* context, const ::google::protobuf_inworld::Empty& request, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus* response) {
  return ::grpc::internal::BlockingUnaryCall< ::google::protobuf_inworld::Empty, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus, ::grpc::protobuf_inworld::MessageLite, ::grpc::protobuf_inworld::MessageLite>(channel_.get(), rpcmethod_RequestAnimationIds_, context, request, response);
}

void AnimationControllerService::Stub::experimental_async::RequestAnimationIds(::grpc::ClientContext* context, const ::google::protobuf_inworld::Empty* request, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::google::protobuf_inworld::Empty, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus, ::grpc::protobuf_inworld::MessageLite, ::grpc::protobuf_inworld::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RequestAnimationIds_, context, request, response, std::move(f));
}

void AnimationControllerService::Stub::experimental_async::RequestAnimationIds(::grpc::ClientContext* context, const ::google::protobuf_inworld::Empty* request, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus>* AnimationControllerService::Stub::PrepareAsyncRequestAnimationIdsRaw(::grpc::ClientContext* context, const ::google::protobuf_inworld::Empty& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus, ::google::protobuf_inworld::Empty, ::grpc::protobuf_inworld::MessageLite, ::grpc::protobuf_inworld::MessageLite>(channel_.get(), cq, rpcmethod_RequestAnimationIds_, context, request);
}

::grpc::ClientAsyncResponseReader< ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus>* AnimationControllerService::Stub::AsyncRequestAnimationIdsRaw(::grpc::ClientContext* context, const ::google::protobuf_inworld::Empty& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
void AnimationControllerService::Stub::experimental_async::PullAnimationDataStream(::grpc::ClientContext* context, ::nvidia_ace::animation_id::v1::AnimationIds* request, ::grpc::experimental::ClientReadReactor< ::nvidia_ace::animation_data::v1::AnimationDataStream>* reactor) {
...
::grpc::ClientWriter< ::nvidia_ace::a2x::v1::AudioStream>* AnimationControllerService::Stub::PushAudioStreamRaw(::grpc::ClientContext* context, ::nvidia_ace::status::v1::Status* response) {
...
void AnimationControllerService::Stub::experimental_async::PushAudioStream(::grpc::ClientContext* context, ::nvidia_ace::status::v1::Status* response, ::grpc::experimental::ClientWriteReactor< ::nvidia_ace::a2x::v1::AudioStream>* reactor) {
...
::grpc::ClientAsyncWriter< ::nvidia_ace::a2x::v1::AudioStream>* AnimationControllerService::Stub::AsyncPushAudioStreamRaw(::grpc::ClientContext* context, ::nvidia_ace::status::v1::Status* response, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncWriter< ::nvidia_ace::a2x::v1::AudioStream>* AnimationControllerService::Stub::PrepareAsyncPushAudioStreamRaw(::grpc::ClientContext* context, ::nvidia_ace::status::v1::Status* response, ::grpc::CompletionQueue* cq) {
...
void AnimationControllerService::Stub::experimental_async::UpdateAnimationGraphVariable(::grpc::ClientContext* context, ::nvidia_ace::status::v1::Status* response, ::grpc::experimental::ClientWriteReactor< ::nvidia_ace::services::animation_controller::v1::AnimationGraphRequest>* reactor) {
...
AnimationControllerService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< AnimationControllerService::Service, ::google::protobuf_inworld::Empty, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus, ::grpc::protobuf_inworld::MessageLite, ::grpc::protobuf_inworld::MessageLite>(
          [](AnimationControllerService::Service* service,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ClientStreamingHandler< AnimationControllerService::Service, ::nvidia_ace::a2x::v1::AudioStream, ::nvidia_ace::status::v1::Status>(
          [](AnimationControllerService::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status AnimationControllerService::Service::RequestAnimationIds(::grpc::ServerContext* context, const ::google::protobuf_inworld::Empty* request, ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status AnimationControllerService::Service::PushAudioStream(::grpc::ServerContext* context, ::grpc::ServerReader< ::nvidia_ace::a2x::v1::AudioStream>* reader, ::nvidia_ace::status::v1::Status* response) {
  (void) context;
  (void) reader;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
