...
void Inworld::ClientBase::StartAudioSession(const Inworld::Routing& Routing, int mode)
{
...
void Inworld::ClientBase::StartAudioSession(const std::string& AgentId, int mode)
{
	StartAudioSession(Inworld::Routing::Player2Agent(AgentId), mode);
}

void Inworld::ClientBase::StartAudioSession(const std::vector<std::string>& AgentIds, int mode)
{
	StartAudioSession(Inworld::Routing::Player2Agents(AgentIds), mode);
}
