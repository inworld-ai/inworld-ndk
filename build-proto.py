...
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/api/annotations.proto", "src/proto/google/api")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/api/client.proto", "src/proto/google/api")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/api/field_behavior.proto", "src/proto/google/api")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/api/http.proto", "src/proto/google/api")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/api/resource.proto", "src/proto/google/api")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/longrunning/operations.proto", "src/proto/google/longrunning")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis/google/rpc/status.proto", "src/proto/google/rpc")