...
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/api/annotations.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/api/client.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/api/field_behavior.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/api/http.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/api/resource.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/longrunning/operations.proto")
Generate(CurDir + "ThirdParty/grpc/third_party/googleapis", "google/rpc/status.proto")