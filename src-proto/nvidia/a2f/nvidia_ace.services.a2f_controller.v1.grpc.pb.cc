...
#include "nvidia/a2f/nvidia_ace.services.a2f_controller.v1.grpc.pb.h"
...
std::unique_ptr< A2FControllerService::Stub> A2FControllerService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< A2FControllerService::Stub> stub(new A2FControllerService::Stub(channel));
  return stub;
}

A2FControllerService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_ProcessAudioStream_(A2FControllerService_method_names[0], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
void A2FControllerService::Stub::experimental_async::ProcessAudioStream(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::nvidia_ace::controller::v1::AudioStream,::nvidia_ace::controller::v1::AnimationDataStream>* reactor) {
