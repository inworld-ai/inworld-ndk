...
#ifndef GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto
...
struct TableStruct_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto;
namespace nvidia {
namespace ace {
namespace audio {
namespace v1 {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::nvidia::ace::audio::v1::AudioHeader* Arena::CreateMaybeMessage<::nvidia::ace::audio::v1::AudioHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace nvidia {
namespace ace {
namespace audio {
...
class AudioHeader PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:nvidia.ace.audio.v1.AudioHeader) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "nvidia.ace.audio.v1.AudioHeader";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::nvidia::ace::audio::v1::AudioHeader_AudioFormat audio_format() const;
  void set_audio_format(::nvidia::ace::audio::v1::AudioHeader_AudioFormat value);
  private:
  ::nvidia::ace::audio::v1::AudioHeader_AudioFormat _internal_audio_format() const;
  void _internal_set_audio_format(::nvidia::ace::audio::v1::AudioHeader_AudioFormat value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:nvidia.ace.audio.v1.AudioHeader)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto;
};
// ===================================================================
...
inline ::nvidia::ace::audio::v1::AudioHeader_AudioFormat AudioHeader::_internal_audio_format() const {
  return static_cast< ::nvidia::ace::audio::v1::AudioHeader_AudioFormat >(audio_format_);
}
inline ::nvidia::ace::audio::v1::AudioHeader_AudioFormat AudioHeader::audio_format() const {
  // @@protoc_insertion_point(field_get:nvidia.ace.audio.v1.AudioHeader.audio_format)
  return _internal_audio_format();
}
inline void AudioHeader::_internal_set_audio_format(::nvidia::ace::audio::v1::AudioHeader_AudioFormat value) {
  
  audio_format_ = value;
}
inline void AudioHeader::set_audio_format(::nvidia::ace::audio::v1::AudioHeader_AudioFormat value) {
  _internal_set_audio_format(value);
  // @@protoc_insertion_point(field_set:nvidia.ace.audio.v1.AudioHeader.audio_format)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioHeader::channel_count() const {
  // @@protoc_insertion_point(field_get:nvidia.ace.audio.v1.AudioHeader.channel_count)
...
inline void AudioHeader::set_channel_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:nvidia.ace.audio.v1.AudioHeader.channel_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioHeader::samples_per_second() const {
  // @@protoc_insertion_point(field_get:nvidia.ace.audio.v1.AudioHeader.samples_per_second)
...
inline void AudioHeader::set_samples_per_second(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:nvidia.ace.audio.v1.AudioHeader.samples_per_second)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioHeader::bits_per_sample() const {
  // @@protoc_insertion_point(field_get:nvidia.ace.audio.v1.AudioHeader.bits_per_sample)
...
inline void AudioHeader::set_bits_per_sample(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:nvidia.ace.audio.v1.AudioHeader.bits_per_sample)
}
...
template <> struct is_proto_enum< ::nvidia::ace::audio::v1::AudioHeader_AudioFormat> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nvidia::ace::audio::v1::AudioHeader_AudioFormat>() {
  return ::nvidia::ace::audio::v1::AudioHeader_AudioFormat_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcommon_2dinterface_2dproto_2fnvidia_2eace_2eaudio_2ev1_2eproto
