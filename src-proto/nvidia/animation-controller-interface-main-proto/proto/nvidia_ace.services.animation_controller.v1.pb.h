...
#ifndef GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto
...
struct TableStruct_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::nvidia_ace::services::animation_controller::v1::AnimationGraphRequest* Arena::CreateMaybeMessage<::nvidia_ace::services::animation_controller::v1::AnimationGraphRequest>(Arena*);
template<> ::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus* Arena::CreateMaybeMessage<::nvidia_ace::services::animation_controller::v1::AnimationIdsOrStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace nvidia_ace {
namespace services {
namespace animation_controller {
...
class AnimationGraphRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "nvidia_ace.services.animation_controller.v1.AnimationGraphRequest";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto);
    return ::descriptor_table_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto;
};
// -------------------------------------------------------------------

class AnimationIdsOrStatus PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:nvidia_ace.services.animation_controller.v1.AnimationIdsOrStatus) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "nvidia_ace.services.animation_controller.v1.AnimationIdsOrStatus";
  }
  protected:
...
inline const ::nvidia_ace::animation_id::v1::AnimationIds& AnimationGraphRequest::animation_ids() const {
...
inline ::nvidia_ace::animation_id::v1::AnimationIds* AnimationGraphRequest::mutable_animation_ids() {
...
inline void AnimationGraphRequest::set_allocated_animation_ids(::nvidia_ace::animation_id::v1::AnimationIds* animation_ids) {
...
inline void AnimationGraphRequest::set_animation_graph_variable_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_name)
}
inline void AnimationGraphRequest::set_animation_graph_variable_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_name)
}
inline void AnimationGraphRequest::set_animation_graph_variable_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_name)
}
...
inline void AnimationGraphRequest::set_animation_graph_variable_value(std::string&& value) {
  ...
  animation_graph_variable_value_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_value)
}
inline void AnimationGraphRequest::set_animation_graph_variable_value(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_value)
}
inline void AnimationGraphRequest::set_animation_graph_variable_value(const char* value,
    size_t size) {
  ...
  animation_graph_variable_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:nvidia_ace.services.animation_controller.v1.AnimationGraphRequest.animation_graph_variable_value)
}
...
inline ::nvidia_ace::animation_id::v1::AnimationIds* AnimationIdsOrStatus::release_animation_ids() {
  ...
  if (_internal_has_animation_ids()) {
    clear_has_response();
      ::nvidia_ace::animation_id::v1::AnimationIds* temp = response_.animation_ids_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::nvidia_ace::animation_id::v1::AnimationIds& AnimationIdsOrStatus::_internal_animation_ids() const {
  return _internal_has_animation_ids()
      ...
      : reinterpret_cast< ::nvidia_ace::animation_id::v1::AnimationIds&>(::nvidia_ace::animation_id::v1::_AnimationIds_default_instance_);
}
inline const ::nvidia_ace::animation_id::v1::AnimationIds& AnimationIdsOrStatus::animation_ids() const {
...
inline void AnimationIdsOrStatus::unsafe_arena_set_allocated_animation_ids(::nvidia_ace::animation_id::v1::AnimationIds* animation_ids) {
  clear_response();
  if (animation_ids) {
...
inline ::nvidia_ace::animation_id::v1::AnimationIds* AnimationIdsOrStatus::_internal_mutable_animation_ids() {
  if (!_internal_has_animation_ids()) {
    clear_response();
    set_has_animation_ids();
    response_.animation_ids_ = CreateMaybeMessage< ::nvidia_ace::animation_id::v1::AnimationIds >(GetArena());
  }
  return response_.animation_ids_;
}
inline ::nvidia_ace::animation_id::v1::AnimationIds* AnimationIdsOrStatus::mutable_animation_ids() {
...
inline ::nvidia_ace::status::v1::Status* AnimationIdsOrStatus::release_status() {
  ...
  if (_internal_has_status()) {
    clear_has_response();
      ::nvidia_ace::status::v1::Status* temp = response_.status_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::nvidia_ace::status::v1::Status& AnimationIdsOrStatus::status() const {
...
inline void AnimationIdsOrStatus::unsafe_arena_set_allocated_status(::nvidia_ace::status::v1::Status* status) {
  clear_response();
  if (status) {
    set_has_status();
...
inline ::nvidia_ace::status::v1::Status* AnimationIdsOrStatus::_internal_mutable_status() {
  if (!_internal_has_status()) {
    clear_response();
    set_has_status();
    response_.status_ = CreateMaybeMessage< ::nvidia_ace::status::v1::Status >(GetArena());
  }
  return response_.status_;
}
inline ::nvidia_ace::status::v1::Status* AnimationIdsOrStatus::mutable_status() {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_nvidia_2fanimation_2dcontroller_2dinterface_2dmain_2dproto_2fproto_2fnvidia_5face_2eservices_2eanimation_5fcontroller_2ev1_2eproto
